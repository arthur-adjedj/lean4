...
abbrev UnitLikeCache    := PersistentHashMap ExprConfigCacheKey Bool
...
@[inline] def modifyUnitLikeCache (f : UnitLikeCache → UnitLikeCache) : MetaM Unit :=
  modifyCache fun ⟨c1, c2, c3, c4, c5, c6, unitLike⟩ => ⟨c1, c2, c3, c4, c5, c6, f unitLike⟩
